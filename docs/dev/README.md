...
| [Phase 2](./phase-2-seal-signature.md) | 个人签名与 Seal Token | 手绘签名、签名管理、Seal Token 认证 | Phase 1 |
...
| 前端 Hook 测试 | @testing-library/react-hooks | useAuth、useSealToken、usePagination 等 |
